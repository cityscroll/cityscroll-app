...
(function() {
  ...
  Object.assign(W.STRINGS["es"], {
    ...
    tab_alerts: "Alertas",
    landing_tagline: "El registro público de Nueva York, organizado para quienes deben actuar en consecuencia.",
    landing_cta_contracts: "Busca oportunidades de contratos",
    landing_cta_contracts_sub: "licitaciones abiertas, adjudicaciones y plazos",
    landing_cta_staffing: "Explora carreras en la ciudad",
    landing_cta_staffing_sub: "puestos, rangos salariales y exámenes de servicio civil",
    landing_cta_browse: "Explora registros públicos",
    landing_cta_browse_sub: "zonificación, propiedades, reglas de agencias y reuniones públicas",
    landing_ask_placeholder: "busca contratos por tema o agencia…",
    landing_skip_to_tool: "Saltar a la herramienta completa",
    city_careers_heading: "Convierte un puesto en una carrera en la Ciudad",
    city_careers_intro: "Compara aquí puestos oficiales, rangos salariales y requisitos de examen. Luego continúa en los sitios oficiales de la Ciudad.",
    city_careers_jobs: "Buscar empleos actuales de la Ciudad",
    city_careers_exams: "Ver exámenes abiertos de servicio civil",

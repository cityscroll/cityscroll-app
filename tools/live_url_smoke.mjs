 ...
 * (EMAIL HEALTH, STATS SANITY, COVERAGE VINTAGE, COVERAGE SANITY, WORKER ACCESS,
...
Named sets (opt-in; not used by deploy jobs unless selected):
  ...
  post-flip  URL matrix + named incident checks (EMAIL HEALTH, STATS SANITY,
             COVERAGE VINTAGE, COVERAGE SANITY, WORKER ACCESS, HUMAN-PATH JOURNEY)
...
`);
  ...
  if (isPostFlip || opts.namedChecksOnly) {
    ...
    console.log("post-flip named checks: EMAIL HEALTH, STATS SANITY, COVERAGE VINTAGE, COVERAGE SANITY, WORKER ACCESS, HUMAN-PATH JOURNEY");

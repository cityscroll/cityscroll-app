...
function buildPrompt({ repo, prNumber, inventory, diff }) {
  return [
    ...
    `PR NUMBER: ${prNumber}`,
    "",
    "crol-list is a static site (index.html and root-level i18n.js/nl_parse.js/",
    "external_awards.js) plus a Cloudflare Worker (worker/src/). The two can't share code across",
    ...
    "a rule on one side (index.html/i18n.js/nl_parse.js/external_awards.js) without a matching",

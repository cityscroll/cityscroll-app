...
export function renderSourceDocument(registry, coverage) {
  ...
  return [
    ...
    "",
    "## Procurement-plan collector staging",
    "",
    "The official FY2027 Local Law 63 and Local Law 1 index pages publish per-agency XLSX",
    "plans rather than one stable table. A staged host-side collector treats those index pages as",
    ...
    "from `fb86-vt7u`. The fixture proof exercises independent City Record/PASSPort 30% stop rules.",
    "Production materialization and its dated measurement receipt remain disabled until a green",
    "headroom window; no production plan rows or bridge edges are enabled by this stage.",
    "",
    "## Verification",
    "",
    "Run:",

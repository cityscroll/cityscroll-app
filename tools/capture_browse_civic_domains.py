#!/usr/bin/env python3
"""Capture before/after civic-domain navigation at phone and desktop widths."""
...
OUTPUT = ROOT / "docs" / "screenshots" / "browse-civic-domains"
...
def capture_tree(browser, tree: Path, phase: str) -> list[dict]:
    records: list[dict] = []  # Source: the ROUTES × VIEWPORTS capture matrix below.
    with StaticServer(tree / "site") as base:
        for width, height in VIEWPORTS:
            ...
            for route in ROUTES:
                ...
                target = OUTPUT / f"{phase}-{route_name}-{width}.png"

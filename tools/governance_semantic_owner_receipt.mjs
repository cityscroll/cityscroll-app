...
const MANIFEST = "docs/repository-governance/classification.v1.json";
const OUTPUT = resolve(ROOT, "docs/repository-governance/semantic-owner-mapping.v1.json");
...
function build() {
  ...
  return {
    schema: "cityscroll.repository_governance_semantic_owner_mapping.v1", card: "cityscroll-engineering/semantic-owner-migration",
...
} else { writeFileSync(OUTPUT, expected); console.log("wrote docs/repository-governance/semantic-owner-mapping.v1.json"); }

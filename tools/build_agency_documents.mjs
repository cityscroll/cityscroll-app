...
<p class="node-lede">Browse the agencies represented in CityScroll’s reviewed identity registry. Each page opens that agency’s cross-category constellation (contracts, meetings, rules, staffing exams) when materialization has links, plus a path to the interactive profile.</p></header>

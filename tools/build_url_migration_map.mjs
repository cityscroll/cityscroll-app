...
const PATTERN_ROWS = [
  ...
  ["Contracts lens view", "/#money?{filters}", "/browse/contracts/?{filters}", "Forward the Contracts allowlist; disclose obsolete keys.", "Legacy root location.replace().", "/#money?closing=week"],
  ["Staffing lens view", "/#people?{filters} and /#staffing?{filters}", "/browse/staffing/?{filters}", "Forward the Staffing allowlist; lang may move from the fragment into the document query.", "Legacy root location.replace().", "/#staffing?lang=es&view=guide"],
  ["Zoning lens view", "/#land?{filters}", "/browse/zoning/?{filters}", "Forward the Zoning allowlist; item routes remain legacy in this increment.", "Legacy root location.replace().", "/#land"],
  ["Property lens view", "/#property?{filters}", "/browse/property/?{filters}", "Forward the Property allowlist; disclose obsolete keys.", "Legacy root location.replace().", "/#property?boro=Brooklyn&view=archive"],
  ["Rules lens view", "/#rules?{filters}", "/browse/rules/?{filters}", "Forward the Rules allowlist; disclose obsolete keys.", "Legacy root location.replace().", "/#rules?q=BRONX+CURB"],
  ["Meetings lens view", "/#meetings?{filters}", "/browse/meetings/?{filters}", "Forward the Meetings allowlist; disclose obsolete keys.", "Legacy root location.replace().", "/#meetings?q=IDA&when=upcoming"],

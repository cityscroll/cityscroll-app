...
| `site/app/entities.mjs` | Official, agency, and vendor profiles; vendor phase timeline and forecasts. `site/vendor_footprint.mjs` is the vendor-route-lazy, strong-link-only footprint renderer and scope composer. |

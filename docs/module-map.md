...
| `site/derived_feature_rollup.mjs` | Pure incremental counts, date spans, lifecycle buckets, and freshness facts for materialized civic rows; keeps corpus totals separate from bounded previews. |

...
| [`guide-review/consumer-handoff-pointer.json`](guide-review/consumer-handoff-pointer.json) | Retained producer report, section, and consumer receipt for the private weekly consumer, with deduplication keys and replay evidence. |

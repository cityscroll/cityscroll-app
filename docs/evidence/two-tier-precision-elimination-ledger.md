...
| OTI agency former-name / successor densify | Dated kill sample 2026-08-11: 10 known renames (incl. gold `gv0-026`) + 5 hard negatives; edges only from OTI `t3jq-9nkf` `alternate_or_former_names` / acronyms | densify 10/10 positive joins after materialization, 0/5 negative merges (precision 100%); residual renames 6→0 | High-consequence identity merges require ≥95% precision and zero hard-negative merges; receipt `site/data/agency_sources/verification_receipts/agency_successors_2026-08-11.json` |

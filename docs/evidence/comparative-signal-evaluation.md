...
| Yield | 3 / 9078 | 0.03% | This is an output-per-eligible-input rate, not a signal count. Award rank is 1/1 within its committed allowlist; amount change is 2/9077 positive amount pairs. |

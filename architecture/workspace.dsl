workspace {
    ...
    model {
        ...
        private_desk -> worker_api "Reads the private /admin/performance model through a server-to-server authenticated proxy; no Analytics Engine credentials cross into Desk [architecture/performance-observability.v1.json; data/desk-contract-fixtures/desk-consumer-contract.v1.json]" "HTTPS"

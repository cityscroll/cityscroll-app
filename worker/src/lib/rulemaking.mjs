...
function objectForRows(rows, { now = null, ruleVersionDocumentsByRequestId = {} } = {}) {
  ...
  return {
    ...
    diffs: versionProjection.diffs,
    comment_observations: versionProjection.comment_observations,
    agency_explanations: versionProjection.agency_explanations,
    version_pairing_issues: versionProjection.pairing_issues,

...
export function parseContractTransaction(txXml) {
  return {
    ...
    awardMethod: extractTag(txXml, "prime_contract_award_method"),
    documentCode: extractTag(txXml, "document_code"),
    ocaNumber: extractTag(txXml, "prime_oca_number"),
    industry: extractTag(txXml, "prime_contract_industry"),
    purpose: extractTag(txXml, "prime_contract_purpose"),
    contractType: extractTag(txXml, "prime_contract_type"),
    contractVersion: extractTag(txXml, "prime_contract_version"),
    parentContractId: extractTag(txXml, "parent_contract_id"),

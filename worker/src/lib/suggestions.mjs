...
// Generated by tools/validate_presets.mjs from live counts. The site copy and this worker copy
// are both checked against data/preset-validation.json before deployment.

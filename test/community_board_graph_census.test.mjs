...
test("meeting measurements distinguish title signals from typed committee identity", () => {
  assert.deepEqual({
    ...
    record_count: 411,
    boards_with_records: 23,
    records_explicitly_identifying_committee: 202,
    records_with_structured_committee_field: 54,
    records_whose_title_exactly_matches_known_local_committee: 0,
    full_board_records: 37,
    explicit_public_hearing_records: 8,
    joint_committee_records: 6,
    records_without_typed_institution_host: 411,
    committee_records_with_unresolved_host_body: 202,
  });
});

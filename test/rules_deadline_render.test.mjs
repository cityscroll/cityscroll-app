...
test("rule event gaps stay absent from the lifecycle surface", () => {
  assert.doesNotMatch(html, /rule_event_not_yet_ingested_html/);
  assert.doesNotMatch(html, /rule_event_not_published_html/);
});

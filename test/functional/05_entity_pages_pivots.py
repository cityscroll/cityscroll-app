...
with sync_playwright() as pw:
    ...
    coverage = {
        ...
        "meetings": {"eligible": None, "linked": 6, "rate": None,
                     ...
                     "gap": "eligible_denominator_not_measured"},
        "council_matters": {"eligible": 78, "linked": 32, "rate": 32 / 78,
                            "scope": "retained_council_matter_appearances",
                            "vintage": "2026-09-05T00:00:00.000Z"},
    ...
    groups = [
        ...
        {"id": "council_matters", "relation": "about_project", "surface": "land",
         "status": "not_observed", "gap": "no_exact_council_matter_edge_in_bounded_corpus",
         "documents": [], "items": [], "coverage": coverage["council_matters"]},

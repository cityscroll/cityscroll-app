...
with sync_playwright() as pw:
    ...
    # The landing-identity layer (card 8) — its own short keyboard walk, on a genuinely
    # fresh visit (not inoculated, unlike the walk above): skip link, both CTAs, the
    # relocated ask input + button, then the muted "more" link.
    LANDING_STOPS = 6

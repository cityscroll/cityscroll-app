...
const STRINGS = {
  en: {
    ...
    std_li_ci_scan: "An automated accessibility scan (axe) runs in continuous integration against this page. A change that introduces a new critical or serious violation fails the build.",

...
const STRINGS = {
  en: {
    ...
    meetings_widened_notice: "No results for {query} in {original}. Showing {shown}.",
    show_exact_search: "Show exact search",
    past_tag: "Past",
    no_hearings_after_widening: "No matching meetings were found, even after checking recent past meetings. Clear a filter to see more.",
    ...
    staffing_explore_all_exams: "Explore all exams and how to apply",
    ...
    career_browser_note: "Open exams come first. Upcoming dates are tentative until DCAS posts the NOE.",
    ...
    stats_h_usage: "How people use CROL-List",
    ...
    stats_usage_unavailable: "These totals are not ready yet.",
    ...
    std_lang_ur: "Urdu",
    std_lang_pl: "Polish",
    std_p_language_summary: "{n} of {total} Local Law 30 languages are in CROL-List's switcher today. {r} of those are native-reviewed.",
    ...
    std_foot_html: "CROL-List · <a href=\"about.html\">About</a> · <a href=\"data.html\">The Data</a> · <a href=\"changelog.html\">Changelog</a> · <a href=\"index.html\">Home</a>",
  },

...
const STRINGS = {
  en: {
    ...
    career_explorer_heading: "Explore titles, pay, and career ladders",
    career_explorer_deck: "Already have a job title in mind? Compare official titles with recent City payroll and active civil-service lists.",

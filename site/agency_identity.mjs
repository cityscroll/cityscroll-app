...
export const AGENCY_GROUPS = Object.freeze({
  ...
  "Metropolitan Transportation Authority": ["MTA", "METROPOLITAN TRANSPORTATION AUTHORITY"],
  "MTA Construction & Development": ["MTA C&D", "MTA CONSTRUCTION AND DEVELOPMENT", "MTA CONSTRUCTION & DEVELOPMENT"],
  "Long Island Rail Road": ["LIRR", "LONG ISLAND RAIL ROAD"],
  "Metro-North Railroad": ["METRO-NORTH", "METRO-NORTH RAILROAD", "MNR"],
  "MTA Bus": ["MTA BUS", "MTABUS", "MTABC"],
  "N.Y.C. Transit Authority": ["NYCT", "NYC TRANSIT", "NEW YORK CITY TRANSIT AUTHORITY"],
  "Triborough Bridge and Tunnel Authority": ["TBTA", "MTA BRIDGES AND TUNNELS", "MTA BRIDGES & TUNNELS"],

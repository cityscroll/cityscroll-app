...
const PRODUCT_AREA_BY_SOURCE = Object.freeze({
  ...
  "nys-contract-reporter": "contracts",
  "mta-current-opportunities": "contracts",
  "mta-bid-results": "contracts",

...
export function renderAdminCodeProvisionDocument(row, { currentHref = null, changes = [], versions = [], as_of = null, mandateJoins = [], authority_citations = [] } = {}) {
  if (!row) return null;

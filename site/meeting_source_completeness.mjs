...
const legistar = [
  ...
  ...rows(["EventInSiteURL", "EventAgendaFile", "EventMinutesFile"], {
    ...
    document_use: "official Council calendar link plus agenda and minutes hyperlinks on the shared meeting document",
    search_use: "not free-text; publisher URL is the official source handoff",
  ...
  ...rows(["EventLocation", "VenueType", "VenueName", "Building", "Room"], {
    ...
    document_use: "Where line on the shared meeting document",
    search_use: "search_text from the publisher venue",
  ...
  ...rows([
    ...
    document_use: "About this meeting and agenda materials on the shared meeting document",
    search_use: "search_text from publisher agenda item titles and matter names",
    alert_use: "not contributed to meeting alerts",
    disposition: "rendered",
  }),

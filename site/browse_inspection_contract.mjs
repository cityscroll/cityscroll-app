...
export const BROWSE_INSPECTION_SURFACES = Object.freeze([
  freezeSurface({
    ...
    baseline_id: "compact-calendar-title-navigates",
...
export const BROWSE_INSPECTION_LEGACY_BASELINE = Object.freeze([
  Object.freeze({
    id: "compact-calendar-title-navigates",
    path: "site/compact_calendar.mjs",
    marker: "bindCompactMonthCalendar",
    reason:
      "Shared compact-month enhancement still mounts title navigation beside a sibling preview control across calendar hosts.",
    fingerprint: null,
  }),
  Object.freeze({

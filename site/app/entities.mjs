  ...
  box.innerHTML = `<div style="max-width:880px;margin:0 auto">
    ...
    ${(() => {
        ...
        return renderRecordActionRegions({
          ...
          researchHtml: renderResearchNavigation(agencyResearch),
...
function vendorProfileHTML(profile, details, hydrating){
  ...
  return `<div style="max-width:880px;margin:0 auto">
    ...
    <div class="panel route-item" tabindex="-1" style="padding:22px 24px">
      ...
      ${(() => {
        const vendorResearch = projectResearchTools({
          surface: "vendor",
          hasShareHandler: true,
          hasCollectionHandler: true,
        ...
        return renderRecordActionRegions({
          ...
          researchHtml: renderResearchNavigation(vendorResearch),

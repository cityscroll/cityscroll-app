...
function injectNLBoxes(){
  const tabs={people:["#tab-people",".controls"],land:["#tab-land",".controls"],property:["#tab-property",".controls"],rules:["#tab-rules",".controls"],meetings:["#tab-meetings","#meetings-toolbar"],alerts:["#tab-alerts",".grid"]};

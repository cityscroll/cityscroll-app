...
// Browser-safe UI re-exports (SPA must import official_influence_ui.mjs directly —
// this host module pulls entity_resolution and is not safe under a site/ document root).
export {
  ...
  lobbyEdgesForId,
  cfbForId,
} from "./official_influence_ui.mjs";

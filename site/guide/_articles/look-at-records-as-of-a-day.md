...
## Step 3 — Share the selected day

While the date is applied, copy the full browser address and paste it into a new tab.
Check that **As of** holds the same day and the summary still names the cutoff.
Share that address to repeat the filter against the records available when opened.
...
Without JavaScript, submitting the date returns an unfiltered page. Enable JavaScript and press
**Apply** again, then check the summary before relying on the result.

...
has dated events a calendar could hold. On a listing with no such dates it is not offered, so no empty feed is offered. And once the address has reached your calendar app,
CityScroll cannot

...
Press **Preview matches** below the choices. Check that **Watch summary** and **Watch criteria**
both name **Manhattan Community Board 7**. Previewing saves nothing and sends no email.
...
If the preview says it is **not ready**, use its retry control. That answer is unknown, unlike a
loaded preview with no matches. You can still read the board's own published calendar.

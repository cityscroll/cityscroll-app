...
export function buildEmmonsShelterMonitorPack(input = {}) {
  ...
  return {
    ...
    anchors, aliases: ["3218 Emmons", "3218 Emmons Avenue", "Gold Star Inn", "Comfort Inn Sheepshead Bay", "Sheepshead Bay shelter"],

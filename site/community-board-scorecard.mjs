...
export function renderScorecardPage(scorecard, {
  boundaries = {},
  boardNeighborhoodAssociations = null,
  selectedGeo = null,
} = {}) {
  const measured = scorecard.coverage.measured;
  const neighborhoodHtml = boardNeighborhoodAssociations
    ? renderBoardNeighborhoodDirectoryHtml(boardNeighborhoodAssociations, { selectedGeo })
    : "";

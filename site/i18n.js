...
const STRINGS = {
  en: {
    ...
    rule_phase_how_multi_html: "When several City Record notices clearly describe one rulemaking (proposal, hearing, adoption), this timeline groups them into one path. Less certain notices stay separate. Dates come from NYC Rules when the records refer to the same rule.",
    ...
    rules_domain_deck: "City Record Agency Rules notices are grouped by rulemaking stage — proposal, public process (comment and hearing), adoption, then effective date — when the connection between notices is clear.",
    ...
    // data.html
    data_p_lede_html: "The City Record dataset at a glance. Your browser pulls live totals from <a href=\"https://data.cityofnewyork.us/City-Government/City-Record-Online/dg92-zbpx\" target=\"_blank\" rel=\"noopener noreferrer\">NYC Open Data<span class=\"sr-only\"> (opens in new tab)</span></a>. Nothing is saved on the server. The numbers follow the <a href=\"api.html#upstream\">data-quality rules</a>. Stats stay in their own section. We exclude likely data-entry errors: amounts of $10 billion or more. Placeholder deadlines aren't real.",
    ...
    stats_public_notices_label: "City Record posts",
    stats_public_notices_desc: "Rows in City Record data, from the first date to the last.",

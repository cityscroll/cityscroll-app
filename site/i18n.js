...
const STRINGS = {
  en: {
    ...
    lifecycle_ocp_disagreement_html: "City Record and {source} disagree — both shown with sources named.",
    lifecycle_ocp_amount_pair_html: "Amount: {city_record_label} {city_amount} · {ocp_label} {ocp_amount}.",
    ...
    meeting_outcomes_unmatched_default: "No confident match for this City Record notice on title, date, and agency.",
    meeting_outcomes_matter_lbl: "Council matter",
    meeting_outcomes_vote_html: "Vote: {result} (aye {aye} · nay {nay})",
    meeting_outcomes_no_votes_html: "Not yet shown here — votes for matter “{matter}” live in NYC Council Legistar.",

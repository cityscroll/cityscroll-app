...
const STRINGS = {
  en: {
    ...
    subsidy_unmatched_default_reason: "No matching Build NYC or NYC Industrial Development Agency project record was linked to this notice from public sources.",

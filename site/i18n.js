...
const STRINGS = {
  en: {
    ...
    career_oasys_action: "Apply in OASys",
    career_oasys_action_label: "Applications happen in the City's OASys system",
    ...
    career_browser_note: "Open exams come first, sorted by the soonest application deadline. Upcoming dates are tentative until DCAS posts the NOE. Choose an interest area to focus the search on the work.",
    ...
    career_entry_level_welcome: "Entry-level applicants welcome",

...
const STRINGS = {
  en: {
    ...
    stats_coverage_method_html: "These facts count records, not people. A registered source is not the same as a searchable one, and a collected total is not a served total. Visits, search, watches, and email totals stay private. Read the <a href=\"api.html#upstream\">source notes</a> or open the <a href=\"https://api.cityscroll.org/stats\">public JSON</a>.",

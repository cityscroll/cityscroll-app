...
const STRINGS = {
  en: {
    ...
    stats_public_notices_label: "Published notice rows",
    stats_public_notices_desc: "Rows in the indexed notice data, from the first date to the last.",
    stats_public_sources_label: "Main public data sets",
    stats_public_sources_desc: "Public data for news, jobs, land, deals, and pay.",
    ...
    stats_public_current_label: "Latest publication date",

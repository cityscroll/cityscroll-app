...
const STRINGS = {
  en: {
    ...
    entity_intel_lead: "Records linked to {name} in this data snapshot, organized by what they show.",
    ...
    entity_intel_vintage: "Data snapshot {date}",
    ...
    entity_intel_apply_scope: "Apply agency filter",
    entity_intel_view_all_scope: "View all as scope",
    ...
    project_connections_lead: "Exact-key records around this ZAP project, grouped by what they answer.",
    project_connections_apply_scope: "Use project as scope",
    ...
    project_connections_gap_parcels: "No exact project-to-tax-lot link is published in this snapshot.",
    project_connections_gap_meetings: "No exact meeting-to-project edge appears in the bounded corpus.",
    project_connections_gap_decisions: "No decision documents are published for this project.",
    project_connections_gap_notices: "No exact related City Record notice is published in this lookup.",
    project_connections_gap_mih: "No exact Mandatory Inclusionary Housing record is linked to this project in the bounded corpus.",
    project_connections_gap_source: "The related-notice source was unavailable for this build.",
    project_connections_gap_bounded: "No exact connection appears in the bounded corpus.",
    project_connections_coverage_measured: "Coverage: {linked} of {eligible} in {scope}.",
    project_connections_coverage_bounded: "Observed on {linked} projects in {scope}. The eligible denominator is not measured.",
    project_connections_coverage_unknown: "The eligible denominator is not measured for {scope}.",
    ...
    project_connections_vintage: "Snapshot {date}.",
    project_connections_method: "Project and parcel joins require exact ZAP project IDs and exact BBLs. Possible applicant identities stay labeled. Review-only candidates are not linked.",

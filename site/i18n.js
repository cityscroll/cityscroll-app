...
const STRINGS = {
  en: {
    ...
    meeting_outcomes_provenance_html: "Each spine is one Council matter’s path: agenda item → matter → action → vote → attachments, joined from City Record notices to NYC Council Legistar.",

...
const STRINGS = {
  en: {
    ...
    exam_list_prediction_cohort_html: "If you apply, expect the eligible list for exams like this about {months} months after applications close. That is when DCAS can start reaching candidates. Based on {n} past exams since {year}.",
    ...
    about_staffing_formula_html: "CityScroll compares past exams to show how long it may take DCAS to set up an eligible list. This is a past pattern, not a promised date, and it never uses applicant names, scores, or ranks.",

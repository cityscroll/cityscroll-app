...
const STRINGS = {
  en: {
    ...
    land_zoning_base_rate_heading: "Historical base rate",
    land_zoning_base_rate_generic_type: "land-use",
    land_zoning_base_rate_html: "Predicted based on {n} {type} applications since {year}: <b>{approved}% approved</b>, typically {low}–{high} months from certification to final action.",
    land_zoning_base_rate_outcomes: "Recorded outcomes: {approved}% approved · {modified}% modified · {disapproved}% disapproved.",
    land_zoning_base_rate_authority_html: "Statutory deadlines remain the act-by dates. This historical range is context, not a replacement. {link}",
    land_zoning_base_rate_formula_link: "Formula and backtest",

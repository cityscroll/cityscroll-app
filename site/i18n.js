...
const STRINGS = {
  en: {
    ...
    meetings_domain_deck: "Public hearings follow a meeting arc — scheduled, agenda, held, then outcomes — with next steps when attendance or testimony is published. Same-board same-day notices collapse into one card. Affected place drives near-me. Venue is separate. Each notice links to its City Record source.",

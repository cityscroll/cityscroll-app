...
const STRINGS = {
  en: {
    ...
    dcas_fleet_basis: "Surplus goods — not real property. These vehicles do not enter parcel chains, map counts, or parcel exports.",
    dcas_fleet_open: "{n} vehicles in the official weekly list are still open.",
    dcas_fleet_closed: "No rows are currently open in the official weekly list. The latest batch closed {date}.",

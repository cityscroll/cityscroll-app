...
const STRINGS = {
  en: {
    ...
    guide_text_cb9abe9cac75d240: "Public meetings use the same **{control_a}** control. The board, place, and upcoming-event window you already chose stay the boundary. Extra wording only narrows it. Exact Council-matter watches and other topics do not offer these controls.",
    guide_text_0ae2854e25e26fed: "On contracts and public meetings, include any or all of a few words, treat an entry as an exact phrase, or exclude words. Exact Council-matter watches and other topics do not show this control",
    guide_text_ef3143cb770107ad: "The same unstarted watch, now matching those words in the title or body of each record",
    ...
    following_treat_phrase: "Treat this as an exact phrase",
    following_also_require: "Also require",
    following_exclude_label: "Exclude these words or phrases",
    following_more_alternatives: "More alternatives",
    following_more_exclusions: "More exclusions",
    following_excluded_results: "Left-out records",
    following_excluded_why: "Left out because this passage matched the exclusion",
    following_preview_retry: "Retry preview",
    following_preview_continue: "Show more matches",
    following_save_changes: "Save changes",
    following_cancel_edit: "Cancel",
    following_change_matching: "Change what this matches",
    ...
    more_tools_label: "More tools",
    research_tool_evidence: "Check connection evidence",
    research_tool_asOf: "Look at records as of a day",
    research_tool_comparative: "Compare related contracts",
    ...
    land_empty_area_detail: "No zoning projects match this neighborhood with your other filters. Clear the area to look citywide.",
    land_empty_widen: "Clear filters, show all",
    land_clear_area: "Clear this area",
    land_place_index_unavailable_heading: "Neighborhood project list unavailable",
    land_place_index_unavailable_detail: "Your filters are unchanged. Try again when the place index is available.",
    land_place_index_unavailable_status: "Neighborhood project membership is unavailable right now.",
    land_place_index_retry: "Try again",
    ...
    nl_chip_min_remaining_days: "at least {n} days left",
    ...
    exam_list_benchmark_html: "{cohort} benchmark: Across {n} exams since {year}, the median time from application close to eligible-list establishment was about {months} months.",
    exam_list_benchmark_cohort_open_competitive: "Open-competitive",
    exam_list_benchmark_cohort_promotion: "Promotion",
    exam_list_benchmark_cohort_citywide: "Citywide",
    exam_list_prediction_expect_html: "Expect the eligible list about {months} months after applications close.",
    exam_list_prediction_window: "Statistical range {first}–{last}. Median {median}.",
    exam_list_prediction_method: "How this is calculated",
    ...
    api_foot_html: "CityScroll · <a href=\"index.html\">Home</a> · <a href=\"about.html\">About</a> · <a href=\"/use-with-ai/\">Use with AI</a> · <a href=\"/api.html#mcp\">MCP tools</a>",

...
const STRINGS = {
  en: {
    ...
    staffing_results_count: "{n} postings shown",
    ...
    career_not_published: "Not published",
    ...
    subsidy_outcome_unknown_html: "No outcome recorded for this stage yet.",
    subsidy_stage_unmatched_html: "No {stage} record found in {source} for this notice.",
    subsidy_source_build_nyc: "Build NYC / NYCIDA",
    subsidy_source_unavailable_html: "Could not reach {source} to check the subsidy timeline for this notice.",
    subsidy_unmatched_html: "No registration record found for “{title}” — {reason}",
    subsidy_unmatched_default_reason: "No matching NYCIDA/Build NYC project record was linked to this notice from public sources.",
    subsidy_matched_html: "Linked project: <b lang=\"en\" dir=\"ltr\">{project}</b> · company <b lang=\"en\" dir=\"ltr\">{company}</b> · stage {stage}.",
    subsidy_company_unknown_html: "No company name found on the linked Build NYC project record.",
    subsidy_place_unknown_html: "No project address or BBL found on the linked Build NYC project record.",
    subsidy_money_unknown_html: "No {field} amount stated in the public Build NYC record.",
    ...
    meeting_outcomes_unmatched_html: "No Council meeting or vote record found for this notice — {reason}",
    meeting_outcomes_unmatched_default: "No Council event matched this City Record notice on title, date, and agency confidence.",
    meeting_outcomes_matter_lbl: "Council matter",
    meeting_outcomes_vote_html: "Vote: {result} (aye {aye} · nay {nay})",
    meeting_outcomes_no_votes_html: "No vote record found for matter “{matter}”.",
    meeting_outcomes_no_matters_html: "Council event matched, but no matter or agenda item was returned for this notice.",
    meeting_outcomes_document_lbl: "Document",
    meeting_outcomes_provenance_html: "Outcomes join City Record hearing notices to NYC Council Legistar events, matters, and votes when confidence is high enough.",
    ...
    about_p_privacy_intro: "CityScroll uses no accounts, no cookies, no cross-site tracking, no ad tech.",

...
| [NYC Council Legistar API](https://council.nyc.gov/legislation/api/) | Meeting outcomes surface: matching notices to Council agenda trees, voting results, and supporting documents. | Authenticated Web API materialization is recommended after measured modern event join of 100% (2026-07-30) with LEGISTAR_API_TOKEN. Nested EventItems/Votes require the token as token= query on webapi.legistar.com/v1/nyc. Worker secret not installed in this recon PR. |
